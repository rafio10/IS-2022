...
public class GeneraReport extends JDialog {
	...
	public GeneraReport() {
		...
		JTextField TipologiaTextField = new JTextField();
		TipologiaTextField.setBounds(158, 18, 195, 20);
		contentPanel.add(TipologiaTextField);
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				GeneraButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent arg0) {
						...
						String tipologia = (String) TipologiaTextField.getText();
						String mese = (String) MeseTextField.getText();
						
						Boolean Check3 = false;
						Boolean Check4 = false;
						
						String s1 = "File Audio";
						String s2 = "Video";
						String s3 = "Podcast";
						String s4 = "Immagine";
						...
						if ((tipologia.equals(s1)) || (tipologia.equals(s2)) || (tipologia.equals(s3)) || (tipologia.equals(s4))) {
							Check3 = true;
						} else {
							errori.add("La tipologia non è presente in catalogo!");
						}
